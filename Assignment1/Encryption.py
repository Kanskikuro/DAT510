...
OptionBFlipped = transpositionCipher(
    NumericKey, CaesarCipher(plainTextFlipped, offset=24).encoded)
...
start = time.time()
for _ in range(20):
    plainTextFlipped = transpositionCipher(
        NumericKey, CaesarCipher(plainTextFlipped, offset=24).encoded)
